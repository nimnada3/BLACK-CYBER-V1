...
module.exports = {
    ...
    ALIVE_DATA : process.env.ALIVE_DATA || "Hello i am alive (a just with alive message )",
    BOT_INFO : process.env.BOT_INFO || "BLACK-CYBER;BLACK;https://i.imgur.com/DyLAuEh.jpg",
    ...
    STICKER_DATA : process.env.STICKER_DATA || "Black;Cyber",
